...
|---|---|---|
| [irpf](skills/tax/irpf/SKILL.md) | `b3` · `consolidate` · `completeness` | Orchestrator — runs the full investments pipeline end to end from the B3 exports + broker/bank informes. |
...
| [consolidate](skills/tax/consolidate/SKILL.md) | `read` · `generate` | Orchestrator — transcribe every informe, then build the three IRPF fichas. |
