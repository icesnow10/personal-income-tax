...
1. **b3_source** — the three IRPF sheets of `brazil_investments.xlsx` (the [b3](../b3/SKILL.md) output):
   `IRPF_bens_e_direitos`, `IRPF_rendimentos_isentos`, `IRPF_rendimentos_exclusivos`.
...
- **`processed/brazil_investments.xlsx`** (the b3 skill output).
