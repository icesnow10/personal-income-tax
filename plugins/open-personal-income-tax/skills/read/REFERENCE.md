...
- **Valor de ativo B3** sempre do `brazil_investments.xlsx` (custo já com amortização abatida e custódias
...
- **BTG**: tabela limpa com `código CNPJ grupo cód saldo2024 saldo2025 … rendimento`. Para B3, use o
  **grupo/cód** daqui (autoridade), mas lembre que o **valor** do B3 vem da `brazil_investments.xlsx`.
